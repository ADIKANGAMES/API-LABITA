...
class zone extends conexion{
    ...
    public function listaZone($pagina = 1){
        $inicio = 0;
        $cantidad = 100;
        if($pagina > 1){
    ...
    public function obtenerZone($id){
